...
const Portfolio = () => {
  ...
  <div className='my-12 flex flex-col justify-center items-center'>
    <div className='w-full max-w-xs lg:max-w-6xl flex flex-col lg:flex-row'>
      ...
      <span className='block bg-accent p-4 w-full lg:text-left text-center lg:w-3/4  lg:text-xl text-sm font-bold text-primary'>MD. REDWAN AHMED</span>
    </div>
    <div className='w-full max-w-xs lg:max-w-6xl flex flex-col lg:flex-row'>
      <span className='block bg-primary p-4 w-full lg:w-1/4 text-white text-center'>EMAIL</span>
      <span className='block bg-accent p-4 w-full lg:text-left text-center lg:w-3/4   lg:text-xl text-sm font-bold text-primary'>redwan.ahmed.1298@gmail.com</span>
    </div>
    
    <div className='w-full max-w-xs lg:max-w-6xl flex flex-col lg:flex-row'>
      <span className='block bg-primary p-4 w-full lg:w-1/4 text-white text-center'>EDUCATION BACKGROUND</span>
      <span className='block bg-accent p-4 w-full lg:text-left text-center lg:w-3/4   lg:text-xl text-sm font-bold text-primary'>B.Sc in Computer Science and Engineering,National University</span>
    </div>
